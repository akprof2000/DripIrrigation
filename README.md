...
1. Возьмите готовый `DripIrrigation.ino.bin` со [страницы релизов](https://github.com/akprof2000/DripIrrigation/releases) (собирается автоматически в GitHub Actions) — или соберите сами (`Скетч → Экспорт бинарного файла` в Arduino IDE)
