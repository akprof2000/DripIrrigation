...
- **Дельта влажности** — половина гистерезиса вокруг порога, % (0–100)<a id="deltacb"></a>
- **Дельта калибровки** — запас у границ калибровки датчиков, ед. АЦП (0–2048)<a id="boostpump"></a>
...
- **Таймаут Telegram** — через сколько секунд без связи считать её потерянной (120–3600)<a id="calibrate"></a>
