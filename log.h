...
//
// ⚠️ С версии 1.9.3 стоит NONE: раздел приложения был занят на 99 %, и строки
// форматов логов — единственное, что можно вырезать без потери функциональности.
// Диагностика по Serial при этом ОТСУТСТВУЕТ полностью, включая сообщения об
// отказе RTC/SD/PCF8574. Их видно в чате: реестр неисправностей (faults.h) и
// отчёты бота работают независимо от логгера. Для отладки на стенде вернуть
// LOG_LEVEL_DEBUG и пересобрать.
#ifndef LOG_LEVEL
